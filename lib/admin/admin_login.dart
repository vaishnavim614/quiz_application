...
import 'package:quiz_application/admin/add_quiz.dart';
...
class _AdminLoginState extends State<AdminLogin> {
              ...
              Material(
                ...
                child: Column(children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration (
                      border: Border.all(color: Color.fromARGB(255,100,160,147)),borderRadius: BorderRadius.circular(10),
                    ),
  ...
  LoginAdmin(){
    FirebaseFirestore.instance.collection("Admin").get().then((snapshot) => {
      snapshot.docs.forEach((result) {
        if (result.data()['id'] == usernamecontroller.text.trim() && result.data()['password'] == userpasswordcontroller.text.trim()) {
          Route route=MaterialPageRoute(builder: (context) => AddQuiz());
          Navigator.pushReplacement(context, route);
        }
        else{
